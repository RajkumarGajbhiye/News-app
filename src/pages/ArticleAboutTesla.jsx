...
const ArticleAboutTesla = () => {
  const [news, setNews] = useState([]);
  const Callapi = () => {
    axios.get("https://newsapi.org/v2/everything?q=tesla&from=2023-02-03&sortBy=publishedAt&apiKey=2e09da319c4049ba9f32dfa43965ca53").then(response => {
...
export default ArticleAboutTesla